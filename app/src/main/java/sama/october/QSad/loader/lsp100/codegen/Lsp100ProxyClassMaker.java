...
package sama.october.QSad.loader.lsp100.codegen;
...
import sama.october.QSad.loader.hookapi.IClassLoaderHelper;
import sama.october.QSad.loader.lsp100.Lsp100HookImpl;
import sama.october.QSad.loader.lsp100.Lsp100HookWrapper;
import sama.october.QSad.loader.lsp100.dyn.Lsp100CallbackProxy;
...
public class Lsp100ProxyClassMaker {
    ...
    private static String getClassNameForPriority(int priority) {
        return "sama.october.QSad.loader.lsp100.dyn.Lsp100CallbackProxy$" + priorityToShortName(priority);
    }
