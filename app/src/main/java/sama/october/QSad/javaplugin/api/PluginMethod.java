package sama.october.QSad.javaplugin.api;
...
import sama.october.QSad.javaplugin.loader.LoadJarHelper;
import sama.october.QSad.javaplugin.loader.PluginCompiler;
import sama.october.QSad.javaplugin.loader.PluginInfo;
import sama.october.QSad.utils.error.PluginError;
import sama.october.QSad.utils.json.JsonConfigUtils;
...
public class PluginMethod {
    ...
    public void addMenuItem(String name, String callback) {
        mPluginCompiler.addMenuItem("[QSad]," + mPluginInfo.pluginId + "," + name, callback);
    }
    ...
    public void addMenuItem(String name, String callback, int[] msgTypes) {
        ...
        mPluginCompiler.addMenuItem("[QSad]," + mPluginInfo.pluginId + "," + name + "," + types, callback);
    }
